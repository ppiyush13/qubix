    ...
    return (
        <Box border={'1px dashed blue'} padding={'1rem'}>
            ...
            <FlexBox gap={'1rem'} column>
                <Box border={'1px dashed blue'} padding={'0.5rem'}>Child 1</Box>
                <Box border={'1px dashed blue'} padding={'0.5rem'}>Child 2</Box>
                <Box border={'1px dashed blue'} padding={'0.5rem'}>Child 3</Box>
            </FlexBox>
        </Box>
    );
}
